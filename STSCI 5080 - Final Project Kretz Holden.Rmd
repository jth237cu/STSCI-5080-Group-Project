...
t.test(num2016, num2015, alternative="less", conf.level=0.95, paired=T) # comment on choice paired=T
...
```{r csat_load_data}
diamonds2 <- read.table("../csat_data.csv", header=T)
